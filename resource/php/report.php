...
$config = new config;
$con = $config->Connect();
$sql = "SELECT * FROM `quiz` WHERE `quiz_id` >= 2 ";
$data = $con->prepare($sql);
$data->execute();
$rows = $data->fetchAll();
           echo "<table class='table table-dark table-striped table-bordered table-sm table-hover table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl' style=width:100%>";
           echo '<tr>';
